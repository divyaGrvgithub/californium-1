...
router.get('/test-me', function (req, res) {
    ...
    console.log("solution of 1st problem",log.myFunction())
    console.log("solution of second problem",uti.mydiv())
    // console.log(uti.myMonth())
    // console.log(uti.myBatchInfo())
    console.log("solution of third problem",val.mydivya())
    ...
    console.log(Lo.chunk(monthsname,4));
    ...
    console.log(Lo.tail(oddnumber,9));
    ...
    const allnumber=[2,5,4,2,7,4];
    console.log(Lo.union(allnumber));
